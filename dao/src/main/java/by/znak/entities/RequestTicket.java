...
public class RequestTicket {
    ...
    public RequestTicket(String begin_city, String begin_country, String end_city, String end_country, String data_of_flight, Long count_of_tickets, Integer price_USD) {
